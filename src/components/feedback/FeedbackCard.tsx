    ...
    >
      ...
      <div className="flex items-center gap-3 mt-auto pt-4 border-t border-black/5 dark:border-white/5">
        ...
        <div className="min-w-0">
          <div className="text-sm font-semibold text-zinc-900 dark:text-white truncate transition-colors duration-500">
            {feedback.name}
          </div>
          {feedback.role && (
            <div className="text-xs text-zinc-500 dark:text-zinc-400 truncate transition-colors duration-500">
              {feedback.role}
            </div>
          )}
        </div>
